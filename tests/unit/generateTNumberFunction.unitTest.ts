...
describe('generate TNumber Function', () => {
  ...
  it('should return a 200 response on success', async () => {
    ...
    NumberService.prototype.createTNumber = jest.fn().mockResolvedValue('Something');
  ...
  it('should RETURN error on failure', async () => {
    ...
    NumberService.prototype.createTNumber = jest.fn().mockImplementation(() => Promise.reject(myError));
